...
'''
Load songs from HTML files to database.
'''

folder = r"..\tomikuvZpevnik\docs\songs"

df = pd.read_csv(r"..\tomikuvZpevnik\songs\00_songdb.csv")
...
for i,row in df.iterrows():
    ...
    print(song_name)
    try:
        with open("../tomikuvZpevnik/"+row['path'],"r", encoding='utf-8') as tex:
            content=tex.read()
